...
const Edit = () => {
    ...
    const getData = async () => {
        try {
            const response = await axios.get(`https://66061ceed92166b2e3c34460.mockapi.io/users/${id}` , editData);
...
const handleFormSubmit = async (e) => {
    e.preventDefault();
    try{
    await axios.put(`https://66061ceed92166b2e3c34460.mockapi.io/users/${id}`, editData)
